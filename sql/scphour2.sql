SELECT to_char(CDR_TIMESTAMP,'dd-mm-yyyy') CDR_DATE,to_char(CDR_TIMESTAMP,'HH24') CDR_HOUR
...
WHERE to_char(CDR_TIMESTAMP,'HH24:MI') <'{min}'
GROUP BY to_char(CDR_TIMESTAMP,'dd-mm-yyyy') ,to_char(CDR_TIMESTAMP,'HH24')
,SUBSTR(INSTANCE_ID,1,2),DIAMETER_RESULT_CODES,SERVICE_KEY,CALL_TYPE,IS_ROAMING,IS_CHARGING_OVERRULED,ISBFT
ORDER BY to_char(CDR_TIMESTAMP,'HH24')