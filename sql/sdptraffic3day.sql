SELECT TO_CHAR(timestamp,'YYYY-mm-dd HH24:MI') AS CDRDATE,CP_NAME,contentproviderid as CPID,ACCESSFLAG,BASICCAUSE,INTERNALCAUSE,SUM(CALLCHARGE ) AS REVENUE,COUNT(TRANSACTIONID) AS TOTAL
